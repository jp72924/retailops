...
def register_settings_tools(mcp: FastMCP, client: RetailOpsClient) -> None:
    ...
    async def retailops_update_system_settings(
        ...
        secondary_rate_auto_update_enabled: Optional[bool] = None,
        secondary_rate_source_url: Optional[str] = None,
        secondary_rate_source_field: Optional[str] = None,
        ...
        payload = {
            ...
            "secondary_rate_auto_update_enabled": secondary_rate_auto_update_enabled,
            "secondary_rate_source_url": secondary_rate_source_url,
            "secondary_rate_source_field": secondary_rate_source_field,
